...
const displayCard = (pets) =>{
    ...
    pets.forEach(pet => {
     ...
     <p class="flex items-center gap-1 text-sm  text-nav_color py-2">Price: ${pet.price}$</p>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 items-center gap-7 font-bold">
...
// img like function
 const loadLikeImg = (img) =>{
    ...
    div.innerHTML = `
    <img class="rounded-xl w-[270px]" src= "${img}" alt="img"/>
    `
...
const displayLoadDetails = (data) =>{
    ...
    <div class="sm:w-[450px]"> <img class="rounded-xl w-full object-cover" src="${data.image}"/></div>
    <h2 class="text-2xl font-bold pt-5">${data.pet_name}</h2>
    <div class=" text-left py-4 grid grid-cols-1 sm:grid-cols-2 ">
      ${data.breed == undefined ?
     `<div class="flex items-center sm:gap-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none"  viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
       <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" />
      </svg> 
